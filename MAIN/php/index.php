...
?>
    ...
    <main>
        ...
        <div class="overlay" id="overlay">
            ...
            <div class="geral">
                <div class="pageFunc">
                    <img src="../images/profile1.png"><a href="profile.html" style="top: 60px">Perfil</a><br>
                    <img src="../images/house.png" "><a href="index.html" style="top: 100px">Home</a><br>
                    <img src="../images/heart.png" "><a href="index.html" style="top: 135px">Favoritos</a><br> 
                </div>
                <div class="config">
                    <img src="../images/settings.png"><a href="settings.html" style="bottom: 115px">Configurações</a><br>
                    <img src="../images/info.png" "><a href="info.html" style="bottom: 75px">Info</a><br> 
                </div>
            </div>
        </div>
